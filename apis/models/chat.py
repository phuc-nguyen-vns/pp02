...
class ChatGenerationModel(BaseModel):
    ...
    search_type: Optional[str] = Field(default="hybrid", description="Search method: keyword_search, semantic_search, or hybrid_search")
    ...
    index: Optional[str] = Field(default="agri_chatbot_v2", description="Target index to search")
